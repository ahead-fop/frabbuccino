...
public class GlobalPointcuts extends ContextVisitor
{
    ...
    public GlobalPointcuts(int pass, Job job, AJTypeSystem ts, AJNodeFactory nf)
    {
        super(job, ts, nf);
        this.nodeFactory = nf;
        this.pass = pass;
    ...
    public Node leave(Node parent, Node old, Node n, NodeVisitor v)
    {
        ...
        if (pass == CONJOIN && n instanceof AdviceDecl) {
    ...
    protected AdviceDecl applyMatchingGlobals(PCNode aspct,
                                                 AdviceDecl ad)
    {
