...
import abc.weaving.matching.SMNode;
import abc.weaving.matching.StateMachine;
import abc.weaving.matching.TMStateMachine;
import abc.weaving.weaver.CodeGenHelper;
import abc.weaving.weaver.IndexedCodeGenHelper;
...
public class TraceMatch
{
    ...
    protected void makePrimitiveMaps()
    {
        ...
        tm_weak_ref = Scene.v().getSootClass(
                        "org.aspectbench.runtime.internal.MyWeakRef");
    }
