...
import abc.weaving.aspectinfo.TraceMatch;
...
public class TMDecl_c extends AdviceBody_c implements TMDecl
{
    ...
    public List generateImplementationAdvice(AJNodeFactory nf, TypeNode voidn,
    ...
    protected void makeSymbolAdvice(AJNodeFactory nf, List advice,
    ...
    protected Pointcut orPC(AJNodeFactory nf, Pointcut orig, Pointcut other)
    {
        if (orig == null)
            return other;
    ...
    protected void makeEventAdvice(AJNodeFactory nf, List advice,
    ...
    public void update(GlobalAspectInfo gai, Aspect current_aspect)
    {
        ...
        if (before_around_pc != null) {
            abc.weaving.aspectinfo.AdviceDecl before_ad =
                new abc.weaving.aspectinfo.TMAdviceDecl
        ...
        ((GlobalAspectInfo) gai).addTraceMatch(tm);
    }
