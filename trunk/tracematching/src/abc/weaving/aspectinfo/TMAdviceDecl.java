...
public class TMAdviceDecl extends AdviceDecl
{
    ...
    {
        return (kind == abc.aspectj.ast.TMAdviceDecl.SOME);
    }

    public boolean isSynch()
    {
    	return (kind == abc.aspectj.ast.TMAdviceDecl.SYNCH);
    }
 
    public boolean isBody()
    {
        return (kind == abc.aspectj.ast.TMAdviceDecl.BODY);
    }

    public boolean isOther()
    {
        return (kind == abc.aspectj.ast.TMAdviceDecl.OTHER);
    }
